...
mka systemimage'''
    ...
    stage('Upload Release') {
      ...
      ./halium-install -p pm -u ../out/target/product/harpia/70-harpia.rules -n rootfs.tar.gz  ../out/target/product/harpia/system.img ../out/target/product/harpia/hybris-boot.img harpia && \\
      ZIP=$(ls -1 *.zip)
